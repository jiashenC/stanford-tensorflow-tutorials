...
with tf.variable_scope('fc') as scope:
    ...
    w = tf.get_variable('weights', [input_features, 1024], initializer=tf.random_normal_initializer())
...
with tf.variable_scope('softmax_linear') as scope:
    ...
    w = tf.get_variable('weights', [1024, N_CLASSES], initializer=tf.random_normal_initializer())
